...
const FeedItem = ({
  ...
  return (
    <article className="flex space-x-3 border-b border-gray-extraLight px-4 py-3 cursor-pointer">
      <img src="https://cdn-icons.flaticon.com/png/512/3899/premium/3899618.png?token=exp=1660223355~hmac=cdb4f6412161ffbe4ebf4b120009fbbd" alt="Profile" className="w-11 h-11 rounded-full" />
